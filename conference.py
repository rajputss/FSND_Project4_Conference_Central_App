...
# - - - Session objects - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
    ...
    def _createSessionObject(self, request):
        ...
        if len(sessionNames) > 1:
            ...
            taskqueue.add(params={'speaker': featuredSpeakerText}, url='/tasks/set_featured_speaker')
    ...
    def getFeaturedSpeaker(self, request):
        ...
        return StringMessage(data=memcache.get(MEMCACHE_FEATURED_SPEAKER_KEY) or "No featured speakers.")
